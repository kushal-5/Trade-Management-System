...
var Calender = function Calender(_ref) {
  ...
  var _useState2 = React.useState(parsedDateInitialValue),
...
var NepaliDatePicker = function NepaliDatePicker(props) {
  ...
  React.useEffect(function () {
    setDate(toEnglish(value || bikramSambatJs.ADToBS(new Date())));
  }, [value]);
  ...
  }), showCalendar && date && React__default.createElement(Calender, {
    value: date,
