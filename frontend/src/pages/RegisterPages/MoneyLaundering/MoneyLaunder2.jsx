...
const MoneyLaunder2 = () => {
  ...
  const selected =
    formData?.MoneyLaunder?.isRelatedToHighRankingPolitician || "";

  const handleSelect = (value) => {
    updateNestedField("MoneyLaunder.isRelatedToHighRankingPolitician", value);
  };
  return (
    <div className="top-60 left-[32rem] w-[61.5rem]">
      ...
      <div className="flex flex-col gap-20">
        <label className="text-white font-roboto text-2xl items-start font-normal leading-normal tracking-[0.96px] capitalize">
          Are You Related To A Politician Or A High-Ranking Official?
        </label>

        <div className="flex gap-8 ms-52">
          <div
