...
import BuyOrder from '../BuySell/BuyOrder'
import SellOrder from '../BuySell/SellOrder'
...
const TradeContent = () => {
  ...
  <div className='bg-[#13161B] py-6 '>
    <h1 className='text-[#BDBDBD] text-xl font-semibold ms-6'>Trade Management</h1>
 ...
 {tabs.map((tab, index) => ( 
  ...
  {activeTab=== 0 && (<BuyOrder/>)}
  {activeTab=== 1 && (<SellOrder/>)}
