...
import ClearSettlement from '../Finance/ClearingSettlement'
import FeeCommision from '../Finance/FeeCommision'
...
const FinanceContent = () => {
  ...
  const tabs= [
    ...
    {
      label: `Fee & Commision Management`,
 ...
 {tabs.map((tab, index) => ( 
   <button
    ...
    className={`
     justify-center rounded-md items-center py-3 mt-8 w-[250px]
    ${
      activeTab === index
  ...
  {activeTab=== 0 && (<ClearSettlement/>)}
  {activeTab=== 1 && (<FeeCommision/>)}
